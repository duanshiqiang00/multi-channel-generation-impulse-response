    ...
    for epoch in range(EPOCH):
        ...
        if epoch == EPOCH - 1:
            ...
            curTrainResultSaveHomePath = mkSaveModelResultdir(
                ResultSaveHomePath +
                '/remote_ '+dataFileName+'_htGenLSTMmid_E' + str(EPOCH) + "_LR" + str(LR) + '_LayerN' + str(LayerNumber) + '_filterN' + str(NumberofFeatureChannel))
...
if __name__=='__main__':
    ...
    # dataFileName = 'tur[2-5]Mulmod_F[0.5-85]_D[0.005-0.2]_Rand_20s_512'
