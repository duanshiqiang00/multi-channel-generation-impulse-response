    ...
    for epoch in range(EPOCH):
        ...
        if epoch == EPOCH - 1:
            ...
            curTrainResultSaveHomePath = mkSaveModelResultdir(
                ResultSaveHomePath +
                '/remote_'+dataFileName+'_htGenSmo_E' + str(EPOCH) + "_LR" + str(LR) + '_LayerN' + str(LayerNumber) + '_filterN' + str(NumberofFeatureChannel))
            ...
            for i in range(0, x.shape[0]):
                if i % 200 == 0:
                    ...
                    numpy.savetxt( trainResultSavePath + '/' + trainSavedFileName, trainMergedresult)
...
if __name__=='__main__':
    ...
    dataFilepath = '/media/server/口..口/Duanshiqiang/' \
