...
class dataAbout():
    def load_data(dataPath,timeSignalLength):
        ...
        for dataFileName in dataFileNameLists:
            ...
            print(dataFileNameLists.index(dataFileName))
    ...
    for epoch in range(EPOCH):
        ...
        if epoch == EPOCH - 1:
            ...
            curTrainResultSaveHomePath = mkSaveModelResultdir(
                ResultSaveHomePath +
                '/remote_turbhtGen_'+dataFileName+'_E-' + str(EPOCH) + "_LR-" + str(LR) + '_LayerNum-' + str(
                    LayerNumber) + '_filterNum-' + str(NumberofFeatureChannel))
            ...
            for i in range(0, test_tensor_data1.shape[0]):
                if i % 5 == 0:
                    ...
                    numpy.savetxt(
                        ...
                        '/test_1Col-Res_2col-Sys_3col-predSys_Num-' + str(i) + '_EPOCH-' + str(EPOCH) + '_LR-' + str(
                            LR) + '.txt', testMergedResSysPredSys)
...
if __name__=='__main__':
    npuCloudDirPath = '/home/dc2-user/genHt'
    dataFilepath = npuCloudDirPath+'/data';
    dataFileName = 'turbulentExcitation_T-20s_Fs-512'
    path = dataFilepath+'//'+dataFileName

    ResultSaveHomePath = npuCloudDirPath+'/result';
